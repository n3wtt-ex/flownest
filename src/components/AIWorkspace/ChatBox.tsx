  ...
  return (
    <>
      ...
      <motion.div
        ...
        // DÜZELTME: Sabit bir yükseklik verildi.
        className="w-full h-[480px] bg-slate-900/60 backdrop-blur-lg rounded-2xl border border-slate-700/50 flex flex-col overflow-hidden"
      >
        {/* Header */}
