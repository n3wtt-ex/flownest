...
const SocialProof: React.FC = () => {
  return (
    <section aria-labelledby="trust-heading" className="container px-4 py-20 dark:bg-gray-900">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-10">
        <Card className="bg-card/60 border-border/60 dark:bg-gray-800/60 dark:border-gray-700/60">
          <CardContent className="pt-6 text-center">
            ...
            <div className="text-muted-foreground mt-1 dark:text-gray-400">Tamamlanan kampanya</div>
          </CardContent>
        </Card>
        <Card className="bg-card/60 border-border/60 dark:bg-gray-800/60 dark:border-gray-700/60">
          <CardContent className="pt-6 text-center">
            <div className="text-4xl font-extrabold dark:text-white">%15</div>
            <div className="text-muted-foreground mt-1 dark:text-gray-400">Ortalama yanıt oranı</div>
          </CardContent>
        </Card>
        <Card className="bg-card/60 border-border/60 dark:bg-gray-800/60 dark:border-gray-700/60">
          <CardContent className="pt-6 text-center">
            <div className="text-4xl font-extrabold dark:text-white">99.9%</div>
            <div className="text-muted-foreground mt-1 dark:text-gray-400">SLA & Uptime</div>
          </CardContent>
        </Card>
      </div>
